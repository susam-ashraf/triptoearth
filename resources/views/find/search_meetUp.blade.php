            ...
            <div class="cd-tabs is-ended">
                <div class="nav pull-up">
                    <ul class="cd-tabs-navigation">
                        ...
                        <li><a class="selected" data-content="tab01" href="{{ url('/meet-up') }}/">Meet up</a></li>
...
<div class="cd-item selected" data-content="tab02">
    <form action="{{ url('/search-all-meet-up')}}" method="post" id="frm-meetUpFilterForm" novalidate="" enctype="multipart/form-data" >
                        {{ csrf_field() }}
