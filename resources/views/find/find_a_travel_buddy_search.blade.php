    ...
    <div class="col-xs-12 trip-holder">
        ...
        <div class="col-md-8 col-sm-10 col-xs-12 info-panel">
            ...
            <div class="tripper-info">
                <p>by <a href="">Charlotte Lewis</a></p>
                <p>
    ...
    $(document).ready(function () {
        ...
        $("#city").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "\/find-a-travel-buddy-search?do=getUsersCities",
                    data: {
                        string: request.term
                    },
        ...
        $("#city2").autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: "\/find-a-travel-buddy-search?do=getUsersCities2",
                    data: {
                        string: request.term
                    },
                    success: function (data) {
        ...
        $(document).ready(function () {
            ...
            win.scroll(function () {
                ...
                if ($(document).height() - win.height()*2 <= win.scrollTop()) {
                    $.nette.ajax({
                        url: "\/find-a-travel-buddy-search?offset=0&do=nextPage"
                    });
                }
            });
        });
